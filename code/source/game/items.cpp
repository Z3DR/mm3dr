...
namespace game {
  ...
  void GiveItemWithEffect(u32 gi_item_index) {
    ...
    rnd::util::GetPointer<int(game::GlobalContext*, game::act::Player*)>(0x231038)(gctx, player);
  }
  ...
  bool CanUseItemUnsafe(ItemId item_id) {
    ...
    const auto update_usability = rnd::util::GetPointer<void(GlobalContext*)>(0x1884B0);
  ...
  bool CanUseItem(ItemId item) {
    ...
    const auto get_item_usability_mode = rnd::util::GetPointer<int(GlobalContext*)>(0x1E827C);
