...
desiredSymbols = ("rItemOverrides", "gSettingsContext", "gSpoilerData", "rScrubRandomItemPrices", "rDungeonRewardOverrides", "rCustomMessageTextData", "rCustomMessageColData", "rCustomMessageIconData", "rCustomMessageDelayData", "rCustomMessages", "numCustomMessageEntries", "ptrCustomMessageEntries", "rEntranceOverrides", "rBGMOverrides", "rSfxData")
